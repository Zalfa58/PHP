...
/*Reference
  ...
  - Reference di PHP tidak sama dengan reference di di bahasa pemrograman seperti C/C++ yang memiliki
    fitur pointer
  - Analogi Reference itu seperti file, jika varaible adalah file, dan value nya adalah isi file nya,
...
/*Returning References
  ...
  - Namun hati-hati, gunakan fitur ini jika memang ada alasannnya, karena fitur ini bisa membingungkan*/
function &getValue()
{
    static $value = 100;
    return $value;
